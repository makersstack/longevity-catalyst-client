              ...
              <div className="project_details_head">
                ...
                <div className="post_auth_info">
                  <div className="profile_image">
                    <Link to="profile-contributer.html">
                      <img src={UserProfileImage} alt="userImage" />
                    </Link>
                  </div>
                  <div className="post_user_fet">
                    <a href="profile-contributer.html" className="user_name"
                    >Esther Howard</a
                    >
              ...
              <div className="project_side_bar side_ber_style_2">
                <form action="/" method="post">
                  <div className="input_box">
                    ...
                    <label className="plan plan-button plan-button-colors" for="opt1">
                  ...
                  <div className="input_box">
                    ...
                    <label
                      ...
                      for="kopt4"
                    >
                      <input checked type="checkbox" name="plan" id="kopt4" />
                      <div className="plan-content">
                        <div className="plan-details">
                  ...
                  <div className="input_box required_skills">
                    ...
                    <label className="plan plan-button-colors" for="sk-opt1">
                    ...
                    <label className="plan plan-button-colors" for="sk-opt2">
                      <input
                        type="checkbox"
                        checked=""
                        name="skill"
                    ...
                    <label className="plan plan-button-colors" for="sk-opt3">
                    ...
                    <label className="plan plan-button-colors" for="sk-opt4">
                    ...
                    <label className="plan plan-button-colors" for="sk-opt5">
